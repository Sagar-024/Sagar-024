...
- **Geoapify** for geolocation, **Apify** for real review data
- Category filtering across Indian cuisines
- Framer Motion animations, mobile-first
...
- Dark/Light theme toggle (no flash bug)
